  ...
  const Header = () => (
    <header className="px-6 py-4 flex items-center justify-between shadow-lg"
      ...
      <nav className="flex items-center gap-4">
        <button onClick={() => navigate('/')} className="text-white font-medium hover:bg-white/20 hover:text-white transition-all duration-300 px-3 py-2 rounded-lg hidden md:block">Home</button>
        ...
        <button onClick={() => navigate('/about-us')} className="text-white font-medium hover:bg-white/20 hover:text-white transition-all duration-300 px-3 py-2 rounded-lg hidden md:block">About Us</button>
